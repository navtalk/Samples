    ...
    public function render_chat_modal() {
        ...
        <div id="navtalk-chat-modal" class="navtalk-modal" style="display: none;">
            <div class="navtalk-modal-content">
                ...
                <!-- Real-time container -->
                <div class="navtalk-realtime-container">
                    <!-- Character container -->
                    <div class="navtalk-realtime-character-box">
                        <div class="navtalk-realtime-character-avatar">
                    ...
                    <!-- Call button -->
                    <button class="navtalk-realtime-button navtalk-realtime-button-icon navtalk-realtime-call-button" id="btnRealtime">
                        <svg class="navtalk-realtime-icon" width="22" height="22" viewBox="0 0 22 22" fill="#fff" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Chat content -->
                    <div class="navtalk-realtime-chat"></div>
                </div>
            </div>
        </div>
        <?php
