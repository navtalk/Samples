...
export interface ImageFactory extends HybridObject<{
    ios: 'swift';
    android: 'kotlin';
}> {
    /**
     ...
     */
    createBlankImage(width: number, height: number, enableAlpha: boolean, fill?: Color): Image;
    /**
     ...
     * @param fill If set, fill the whole image with the given color
     */
    createBlankImageAsync(width: number, height: number, enableAlpha: boolean, fill?: Color): Promise<Image>;
    /**
...
//# sourceMappingURL=ImageFactory.nitro.d.ts.map