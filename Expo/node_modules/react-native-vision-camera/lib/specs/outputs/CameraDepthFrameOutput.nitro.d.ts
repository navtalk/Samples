 ...
 */
export interface DepthFrameOutputOptions extends Pick<FrameOutputOptions, 'targetResolution' | 'enablePhysicalBufferRotation' | 'dropFramesWhileBusy' | 'allowDeferredStart'> {
    /**
...
export interface CameraDepthFrameOutput extends CameraOutput {
     ...
     */
    setOnDepthFrameCallback(onDepthFrame: Sync<(depth: Depth) => boolean> | undefined): void;
    /**
     ...
     */
    setOnDepthFrameDroppedCallback(onDepthFrameDropped: ((reason: FrameDroppedReason) => void) | undefined): void;
}
