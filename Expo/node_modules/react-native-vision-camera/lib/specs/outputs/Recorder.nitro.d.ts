 ...
 */
export interface Recorder extends HybridObject<{
    ios: 'swift';
    android: 'kotlin';
}> {
    /**
     ...
     */
    startRecording(onRecordingFinished: (filePath: string) => void, onRecordingError: (error: Error) => void, onRecordingPaused?: () => void, onRecordingResumed?: () => void): Promise<void>;
    /**
