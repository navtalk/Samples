// Ported from HtmlClient/demo.js to an ES module for React usage
  ...
  async function cleanupResources() {
    try {
      if (peerConnectionA) {
        ...
        peerConnectionA.ontrack = null;
        peerConnectionA.onnegotiationneeded = null;
        peerConnectionA.oniceconnectionstatechange = null;
  ...
  async function handleReceivedMessage(data) {
    ...
    if (data.type === NavTalkMessageType.CONNECTED_SUCCESS) {
      if (data.data && data.data.iceServers) {
        ...
        console.log("Updated configuration with ICE servers:", configuration.iceServers);
      }
      console.log("CONNECTED_SUCCESS received");
    }
    ...
    switch (data.type) {
      ...
      case NavTalkMessageType.WEB_RTC_OFFER: {
        console.log('Received WEB_RTC_OFFER');
        handleOffer(data.data);
        break;
      }
      case NavTalkMessageType.WEB_RTC_ANSWER: {
        console.log('Received WEB_RTC_ANSWER');
        handleAnswer(data.data);
        break;
      }
      case NavTalkMessageType.WEB_RTC_ICE_CANDIDATE: {
        console.log('Received WEB_RTC_ICE_CANDIDATE');
